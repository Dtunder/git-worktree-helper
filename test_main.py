...
def test_add_worktree_with_branch(mock_run, mock_exit):
    ...
    mock_run.assert_called_once_with(['git', 'worktree', 'add', '-b', 'my-branch', '/path/to/new-wt'], text=True)
...
def test_add_worktree_no_branch(mock_run, mock_exit):
    ...
    mock_run.assert_called_once_with(['git', 'worktree', 'add', '-b', 'new-wt', '/path/to/new-wt'], text=True)
    mock_exit.assert_called_once_with(0)
...
def test_remove_worktree(mock_run, mock_exit):
    ...
    mock_run.assert_called_once_with(['git', 'worktree', 'remove', '/path/to/wt'], text=True)
    mock_exit.assert_called_once_with(0)
...
def test_remove_worktree_force(mock_run, mock_exit):
    ...
    mock_run.assert_called_once_with(['git', 'worktree', 'remove', '--force', '/path/to/wt'], text=True)
    mock_exit.assert_called_once_with(0)
...
def test_prune_worktrees(mock_run, mock_exit, capsys):
    ...
    mock_run.assert_called_once_with(['git', 'worktree', 'prune'], text=True)
    mock_exit.assert_called_once_with(0)
